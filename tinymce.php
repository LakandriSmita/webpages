...
<body>
  <div id="main">
	...
	<div id="site_content">	
      ...
      <div class="slideshow">
	    <ul class="slideshow">
          <li class="show"><img width="900" height="250" src="building.jpg"  /></li>
          <li><img width="900" height="250" src="img/11.jpg"  /></li>
          <li class="show"><img width="900" height="250" src="img/5.jpg"  /></li>
        </ul> 
	  </div>	
